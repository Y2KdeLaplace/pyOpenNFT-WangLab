...
def test_orth_vol(data_path, nii_image_1, struct_image, orth_matlab, orth_matlab_struct):
    ...
    str_param1 = pov.prepare_orth_view(mat, matResoulution, dim)

    imgt, imgc, imgs = uov.update_orth_view(str_param1, vol, matResoulution)
    ...
    matResoulution = struct_image.affine
